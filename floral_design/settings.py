"""
Django settings for floral_design project.
...
ALLOWED_HOSTS = ['8000-ehdev-floraldesign-e9576ycje1s.ws.codeinstitute-ide.net']
...
WSGI_APPLICATION = 'floral_design.wsgi.application'
